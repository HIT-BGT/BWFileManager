...
public class SDCardCheck_new {

	private static File path;
	private static int SDstat;

	private static long nSDTotalSize;
	private static long nSDFreeSize;
	...
	public static long getnSDFreeSize() {
		return nSDFreeSize;
	}


	public static long getnSDTotalSize() {
		return nSDTotalSize;
	}
