...
public class ResourceDetails extends BaseActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("ResDetails#onCreate", filePath);	//打印调试信息
	...
	private void deleteDialog() {
		AlertDialog.Builder builder = new Builder(ResourceDetails.this);
	...
	private void renameDialog() {
		AlertDialog.Builder builder = new Builder(ResourceDetails.this);
		final EditText editText = new EditText(ResourceDetails.this);    //用于输入新文件名的输入框
